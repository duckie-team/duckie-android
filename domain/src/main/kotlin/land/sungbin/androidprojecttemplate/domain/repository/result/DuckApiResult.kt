...
import land.sungbin.androidprojecttemplate.domain.repository.Repository

/**
 * [Repository] 의 결과를 나타냅니다.
 */
sealed interface DuckApiResult<T> {
    /**
     * [Repository] 에서 API 호출에 예외가 발생했을 때 반환되는 결과입니다.
     *
...
/**
 * [runCatching] 과 유사하며, [Repository] 작업 중 예외 발생시 [DuckApiResult.Exception] 을
 * 반환합니다.
 *
 * @param execute 실행할 [Repository] 작업
 ...
 * 콜백을 실행하는 확장 함수 입니다.
 *
 * @receiver [Repository] 로 부터 받은 결과
