...
interface FetchRepository : DuckRepository {
    ...
    suspend fun fetchChatRooms(
        @FK userId: String,
    ): DuckFetchResult<List<team.duckie.app.android.domain.model.ChatRoom>>
    ...
    suspend fun fetchChatRead(
        @PK @FK userId: String,
    ): DuckApiResult<team.duckie.app.android.domain.model.ChatRead>
    ...
    suspend fun fetchComments(
        @FK feedId: String,
    ): DuckApiResult<List<team.duckie.app.android.domain.model.Comment>>
